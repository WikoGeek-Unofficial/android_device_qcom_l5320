...
//	{ (int)RFC_WTR1605_CHILE_RP1_RF_PATH_SEL_20, { RFC_HIGH, -40 }, {RFC_LOW, 0 }  },	
//	{ (int)RFC_WTR1605_CHILE_RP1_RF_PATH_SEL_06, { RFC_HIGH, -40 }, {RFC_LOW, 0 }  },	
    { (int)RFC_SIG_LIST_END,   { RFC_LOW, 0 }, {RFC_LOW, 0 } }
  },
};
...
//	{ (int)RFC_WTR1605_CHILE_RP1_RF_PATH_SEL_20, { RFC_HIGH, -10 }, {RFC_LOW, 0 }  },	
//	{ (int)RFC_WTR1605_CHILE_RP1_RF_PATH_SEL_06, { RFC_HIGH, -10 }, {RFC_LOW, 0 }  },
    { (int)RFC_SIG_LIST_END,   { RFC_LOW, 0 }, {RFC_LOW, 0 } }
  },
};
...
rfc_device_info_type rf_card_wtr1605_chile_rp1_tx0_gsm_g900_device_info = 
{
  ...
  4,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x01A5 << 22)/*mfg_id*/ | (0x0d << 14)/*prd_id*/ |(14 << 7)/*sec_port_num*/ | (10)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
...
rfc_device_info_type rf_card_wtr1605_chile_rp1_tx0_gsm_g1900_device_info = 
{
  ...
  4,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x01A5 << 22)/*mfg_id*/ | (0x0d << 14)/*prd_id*/ | (16 << 7)/*sec_port_num*/ | (12)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
