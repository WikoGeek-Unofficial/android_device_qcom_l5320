...
rfc_device_info_type rf_card_wtr1605_chile_rp1_tx0_lte_b1_device_info = 
{
  ...
  5,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x01A5 << 22)/*mfg_id*/ | (0x0D << 14)/*prd_id*/ | (19)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
...
rfc_device_info_type rf_card_wtr1605_chile_rp1_tx0_lte_b3_device_info = 
{
  ...
  5,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x01A5 << 22)/*mfg_id*/ | (0x0D << 14)/*prd_id*/ | (8)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
...
rfc_sig_info_type rf_card_wtr1605_chile_rp1_rx0_lte_b7_sig_cfg = 
{
  0x022902DD,   /* Revision: v2.41.733 */
  {
    ...
    { (int)RFC_WTR1605_CHILE_RP1_RX_ON0_alt, RFC_HIGH  },
    { (int)RFC_WTR1605_CHILE_RP1_RF_PATH_SEL_20, RFC_HIGH  },	
    { (int)RFC_WTR1605_CHILE_RP1_RF_PATH_SEL_06, RFC_HIGH  },
    { (int)RFC_SIG_LIST_END,  RFC_LOW  }
  },
};
...
rfc_device_info_type rf_card_wtr1605_chile_rp1_tx0_lte_b20_device_info = 
{
  ...
  5,  /* NUM_DEVICES_TO_CONFIGURE */
  {
    ...
    },
    {
      ...
      {
        0  /* Orig setting:  */,  /* INTF_REV */
        (0x01A5 << 22)/*mfg_id*/ | (0x0D << 14)/*prd_id*/ | (7)/*port_num*/,  /* PORT_NUM */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
        0,  /* Array Filler */
